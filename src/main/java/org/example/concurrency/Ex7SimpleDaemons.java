package org.example.concurrency;//: concurrency/SimpleDaemons.java
...
public class Ex7SimpleDaemons implements Runnable {
  public void run() {
    try {
      while(true) {
  ...
  public static void main(String[] args) throws Exception {
    for(int i = 0; i < 10; i++) {
      Thread daemon = new Thread(new Ex7SimpleDaemons());
